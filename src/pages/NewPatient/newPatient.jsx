    ...
    <>
      <section className='section snap-stop'>
        ...
        <p className='block'>
          ...
          out in the comfort of your own home, all online. This paperwork will
          be detailed and may ask questions you weren’t expecting but answering
          them as completely as possible is important for us to get vital
        ...
        <p className='block'>
          ...
          moving forward and answer any questions you have. Once that has been
          accomplished, we will do state of the art nervous system scans that
          are painless and non-invasive. They will help Dr. Katie determine the
          depth of the distress (subluxation) and objectively measure the stress
          in the patient’s nervous system stopping them from living their best
          life. The appointment will conclude with a spinal exam and orthopedic
          tests.
        </p>
        ...
        <p className='block'>
          ...
          established goals. Our care goes beyond basic symptom-based
          chiropractic to focus on unwinding the stress in the nervous system
          causing it to be stuck and a customized care plan is the vital
          component that allows us to do so. After all of that, you’ll get your
          first adjustment! Dr. Katie will explain everything she’s doing and
          will adjust you according to your scans and her exam findings. She is
          experienced in numerous techniques including diversified, Gonstead,
          Thompson Drop, flexion-distraction, Webster and Activator. She will
          determine what technique will work best for your body and may use a
          combination but please let her know if you have any preferences.
        </p>
      </section>
